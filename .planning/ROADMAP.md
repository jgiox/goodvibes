...
- [ ] **Phase 3: pip CLI** - Port the npm CLI to Python and publish to PyPI as `jgiox-goodvibes` (PyPI name; `goodvibes` taken by chemistry package)
...
- [ ] 03-04-PLAN.md — Wave 2: init_cmd.py (Typer command) + main.py (wiring) + publish-pip.yml (trusted publishing) + PyPI publish human checkpoint
