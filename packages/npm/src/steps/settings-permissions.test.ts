...
describe('guard rails', () => {
  const GUARD_ASK = ['Edit(./.claude/settings.json)', 'Edit(./.claude/settings.local.json)', 'Edit(./.mcp.json)', 'Edit(./.cursor/mcp.json)', 'Edit(./.vscode/mcp.json)', 'Edit(./.claude/hooks/**)', 'Edit(./.codex/hooks.json)', 'Edit(./.gemini/settings.json)', 'Edit(./.github/hooks/**)', 'Edit(./.windsurf/hooks.json)', 'Edit(./.kiro/hooks/**)']
